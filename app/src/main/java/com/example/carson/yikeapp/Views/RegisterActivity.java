...
//                        int phoneNum = Integer.parseInt(etPhone.getText().toString());
                                        ...
                                        new Callback() {
                                            ...
                                            public void onResponse(Call call, Response response)
                                                ...
                                                try {
                                                    ...
                                                    if (code == 200) {
                                                        ConstantValues.cachePsw(RegisterActivity.this,
                                                                pwd);
                                                        runOnUiThread(new Runnable() {
                                                            @Override
                                                            public void run() {
    ...
    private void showRuleDialog() {
        View view = LayoutInflater.from(this).inflate(R.layout.dialog_service_rule, null, false);
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        final AlertDialog dialog = builder.create();
        dialog.setView(view);
        ImageView cancel = view.findViewById(R.id.iv_dialog_cancel);
        dialog.show();
